...
<div class="row">
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<h3>Añadir productos al presupuesto: <?php echo e($presupuesto->codigo); ?></h3>
		...
		<?php endif; ?>
            ...
            <?php echo Form::model($presupuesto,['method'=>'PATCH','route'=>['presupuesto.update',$presupuesto->codigo]]); ?>
