...
<body>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body modalBody">
                                <button class="btn modalButton">Cliente natural</button>
                                <button class="btn modalButton">Cliente juridico</button>
                            </div>
    ...
    <div class="customContainerLogo">
        <div class="container">
            <div class="row">
                <div class="col-sm-4">
                    <a href="index.html"><img class="img-fluid" src="{{asset('usuario/Imagenes/candy.png')}}"></a>
                </div>
                        ...
                        <nav class="navbar navbar-light navbar-expand-lg ">
                            ...
                            <div class="navbar-collapse collapse" id="menuToggle">
                                <ul class="nav  nav-pills">
                                    <li class="nav-item"> <a class="nav-link current botonColor" href="index.html">Inicio</a></li>
        ...
        <div id="carouselNews" class="carousel carousel-news slide" data-interval="5000" data-ride="carousel">
            ...
            <div class="carousel-inner carousel-inner-news">
                <div class="carousel-item carousel-item-news active">
                    <a href="#"><img src="{{asset('usuario/Imagenes/sorpresa1.jpg')}}" class="img-fluid')}}" /></a>
                </div>
                <div class="carousel-item carousel-item-news">
                    <a href="#"><img src="{{asset('usuario/Imagenes/news2.jpg')}}" class="img-fluid" /></a>
                </div>
                <div class="carousel-item carousel-item-news">
                    <a href="#"><img src="{{asset('usuario/Imagenes/news3.png')}}" class="img-fluid" /></a>
                </div>
                <div class="carousel-item carousel-item-news">
                    <a href="#"><img src="{{asset('usuario/Imagenes/news4.jpg')}}" class="img-fluid" /></a>
                </div>
                <div class="carousel-item carousel-item-news">
                    <a href="#"><img src="{{asset('usuario/Imagenes/news5.jpg')}}" class="img-fluid" /></a>
    ...
    <div class="customDiario">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">DIARIO UCAB</div>
            </div>
        </div>
    ...
    <div style="background-color:#f5ceb6">
        <div class="container" >
            <div class="row" style="width:inherit">
                <div class="col-xs-12" style="width:inherit" >
                    <div class="card cardBorder">
                        <div class="card-header panelsCarousel cardHeaderPadding" style="background-color:#f5ceb6"><button data-target="#loMasVendido" class="btn panelsCarousel" style="background-color:#f5ceb6" data-toggle="collapse"><h5 class="card-title" style="background-color:#f5ceb6"> LO MAS VENDIDO <span class="fas fa-angle-up"></span></h5></button></div>

                        <div class="card-body panelsCarousel collapse show" style="background-color:#f5ceb6" id="loMasVendido">
                            <div class=" carousel-control-productos">
                                <a href="#carouselloMasVendido" class="carousel-control-prev float-left" style="width:auto" data-slide="prev">
                                    <span class="carousel-control-prev-icon carousel-control-prev-icon-p"></span>
                                </a>
                                <a href="#carouselloMasVendido" class="carousel-control-next float-right" style="width:auto" data-slide="next">
                                    <span class="carousel-control-next-icon carousel-control-prev-icon-p"></span>
                                </a>
                            </div>

                            <div id="carouselloMasVendido" class="carousel slide" data-interval="0" data-ride="carousel">
    ...
    <div>
        <div class="container">
            <div class="row" style="width:inherit">
                <div class="col-xs-12" style="width:inherit">
                    <div class="card cardBorder">
                        <div class="card-header panelsCarousel cardHeaderPadding"><button data-target="#mejorMes" class="btn panelsCarousel" data-toggle="collapse"><h5 class="card-title"> LO MEJOR DEL MES <span class="fas fa-angle-up"></span></h5></button></div>

                        <div class="card-body panelsCarousel collapse show" id="mejorMes">
                            <div class=" carousel-control-productos">
                                <a href="#carouselmejorMes" class="carousel-control-prev float-left" style="width:auto" data-slide="prev">
                                    <span class="carousel-control-prev-icon carousel-control-prev-icon-p"></span>
                                </a>
                                <a href="#carouselmejorMes" class="carousel-control-next float-right" style="width:auto" data-slide="next">
                                    <span class="carousel-control-next-icon carousel-control-prev-icon-p"></span>
                                </a>
                            </div>

                            <div id="carouselmejorMes" class="carousel slide" data-interval="0" data-ride="carousel">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-4 bottonImg">
                    <img class="img-fluid" src="usuario/Imagenes/candy.png" />
                ...
                <div class="col-sm-4 bottonList">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item"><a href="index.html"><span class="fa fa-circle"></span> Inicio</a></li>
