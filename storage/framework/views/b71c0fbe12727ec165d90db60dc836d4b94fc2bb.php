<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-delete-<?php echo e($p->codigo); ?>">
	...
	<?php echo e(Form::Open(array('action'=>array('PresupuestoController@destroy',$p->codigo),'method'=>'delete'))); ?>
...
<div class="modal-content">
       ...
       <h4 class="modal-title">Eliminar Presupuesto</h4>
			...
			<div class="modal-body">
				<p>¿Seguro que quiere eliminar el Presupuesto: <strong><?php echo e($p->codigo); ?></strong></p>
