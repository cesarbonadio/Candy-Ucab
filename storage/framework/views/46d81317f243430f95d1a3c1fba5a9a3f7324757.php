          ...
          <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
           ...
           <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
             ...
             <select name="fk_naturale" class="form-control">
               <?php $__currentLoopData = $natural; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               <option value="<?php echo e($n->cedula); ?>"> <?php echo e($n->nombre); ?> <?php echo e($n->apellido); ?> (<?php echo e(($n->cedula)); ?>)</option>
               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
             </select>
            </div>
            </div>
